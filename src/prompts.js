...

{
  ...
  "tweet_x": "UN único tweet de 260-278 caracteres para publicar en X. No es un resumen del briefing: elige el ángulo MÁS POTENTE del día y desarróllalo completamente. Aprovecha cada carácter. Estructura: GANCHO (90-110 chars) + salto de línea + DESARROLLO (150-170 chars). GANCHO: el dato más impactante o la paradoja que crea tensión. Para el scroll. PROHIBIDO empezar con 'Hoy', 'El mercado', 'BTC ha'. 1 emoji si refuerza (📊🔴🟢⚠️). Técnicas: número que crea tensión ('68.200$ separa a los holders en verde del resto'), contrarian ('El OI sube. El precio no.'), urgencia ('En 3h sale el CPI. El mercado espera X. La última vez que se equivocó...'), paradoja ('Funding negativo. Precio plano. Esto ha pasado 4 veces. En 3 de ellas...'). DESARROLLO: qué implica para el precio, nivel exacto a vigilar, y termina con pregunta corta que la comunidad pueda responder en 5 palabras (elección forzada o predicción de precio). Sin HTML. Sin guiones largos. Sin links.",
...

{
  ...
  "tweet_x": "UN único tweet de 230-255 caracteres para publicar en X. Elige el dato o movimiento MÁS impactante de la semana y desarróllalo. GANCHO (90-110 chars): cifra o paradoja que para el scroll. DESARROLLO (resto): qué implica para la semana siguiente. Termina con pregunta corta. Sin HTML. Sin guiones largos. Sin links. Sin hashtags. Sin mencionar Telegram.",
