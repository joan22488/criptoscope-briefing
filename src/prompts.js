...

{
  ...
  "thread": [
    "Tweet 1 — HOOK (240-280 chars): Este tweet decide si alguien lee el resto. Tienes 2 segundos para parar el scroll. TÉCNICAS (elige la que más encaje con el día): (A) Tensión numérica: '68.200$. Ese es el nivel que separa a los holders en verde de los que están esperando. Y hay una razón técnica muy concreta por la que ese número importa hoy:' (B) Contrarian: 'El mercado lleva 3 días en modo pánico. El OI dice otra cosa. Hilo:' (C) Stakes personales: 'Si tienes posición abierta en BTC ahora mismo, hay 3 datos del día de hoy que deberías ver antes de cerrar la sesión:' (D) Paradoja o dato que sorprende: 'Funding negativo. Precio plano. Volumen cayendo. Esto ha pasado 4 veces en el último año. En 3 de ellas, lo que pasó después fue...' (E) Urgencia real: 'En 4 horas sale el CPI. El mercado espera +0,2%. La última vez que se equivocó en esta cifra, BTC cayó un 8% en 90 minutos.' PROHIBIDO empezar con: Hoy / El mercado / BTC ha / Good morning / Buenos días / Esta semana. La primera palabra debe ser un número, un hecho o una frase que cree intriga inmediata.",
    ...
    "Tweet 6 — PREGUNTA (180-260 chars): La pregunta tiene que hacer que alguien con posición abierta NECESITE responder. Fórmulas que generan replies: (A) Elección forzada: '¿Reducís exposición aquí o mantenéis hasta la zona de 72k?' (B) Experiencia personal: '¿Habéis cerrado algo esta semana o seguís full in?' (C) Opinión con contexto: 'Con el CPI mañana y el funding en negativo, ¿estáis cortos, largos o flat?' (D) Predicción verificable: '¿Dónde veis a BTC el viernes? Dejad el número.' REGLA: que se pueda responder en 5 palabras o menos. Si la pregunta necesita explicación, es demasiado larga."
  ],
