...
// ── Portada editorial gpt-image-1 (CriptoScope Visual Style v2: ilustración conceptual) ──
const MASTER_PROMPT = `Bold conceptual editorial illustration in the style of an award-winning business magazine cover (Bloomberg Businessweek, The Economist). Flat graphic illustration with clean shapes and strong silhouettes. NOT a photograph, NOT a 3D render, NOT photorealistic. Composition: ONE single oversized visual metaphor as the hero object, placed with generous negative space around it. Color palette strictly limited to three: near-black graphite background, warm off-white ivory shapes, and ONE vivid emerald green accent (#00C896) reserved for the key element only. Subtle halftone print-grain texture, like a printed magazine. The concept must be witty, intelligent and slightly surreal: translate the news topic into one unexpected everyday object or scene, examples of the tone: a paper boat folded from a banknote on a dark sea, a marble column with a hairline crack, a single chess piece casting an impossibly long shadow, a house of cards where one card glows green, a tightrope stretched between two filing cabinets, an hourglass where the sand pools upward. Dramatic single light source with long theatrical shadows. STRICTLY FORBIDDEN: Bitcoin or Ethereum coin symbols, any cryptocurrency logo, blockchain network visualizations, candlestick charts, price graphs, rockets, moons, bulls, bears, laser eyes, trading screens, monitors, keyboards, businessmen in suits, handshakes, city skylines, vault doors, piggy banks. No text, no letters, no numbers, no watermarks, no logos anywhere in the image. Iconic, memorable, museum-poster quality. 16:9.`;
