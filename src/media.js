...
const MASTER_PROMPT = `Ultra-realistic editorial photograph for a premium crypto financial news outlet. Dark graphite and matte black environment with subtle emerald green (#00C896) accent lighting. Institutional atmosphere: premium trading desk with illuminated monitors at night, architectural photography of financial districts, abstract macro close-ups of materials (glass, brushed metal, circuit boards), urban financial skyline from above with reflections. Hyper-realistic lighting, shallow depth of field, cinematic color grading. Translate the news topic into ONE concrete visual metaphor: for BTC/market topics use a trading room, glowing Bloomberg terminal, architectural glass tower at dusk; for regulation/legal topics use formal marble architecture or abstract scales; for macroeconomics use abstract 3D data landscape or financial document close-up; for ETF/institutional topics use wall street trading floor or institutional desk. STRICTLY AVOID: floating Bitcoin or Ethereum coins, blockchain network visualizations, cryptocurrency logos, rockets, moon imagery, bulls, bears as literal animals, generic skylines, stock photo compositions, cliché tech backgrounds. No text, no watermarks, no readable numbers, no UI overlays, no branding. Premium magazine cover quality. 16:9 aspect ratio.`;
