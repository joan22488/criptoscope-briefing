...
// ── Portada editorial gpt-image-1 (CriptoScope Visual Style v3: bodegón conceptual 3D) ──
const MASTER_PROMPT = `Premium conceptual cover art for a financial magazine, in the tradition of the boldest Bloomberg Businessweek and The Economist covers. Style: a dimensional, sculptural still-life scene rendered with tactile realistic materials (carved marble, matte ceramic, folded paper, waxed wood, soft rubber, frosted glass), lit like a high-end studio product shoot with one dramatic key light and long soft theatrical shadows. It must feel like a physical art installation photographed for a cover, NOT flat vector art, NOT a stock photo, NOT a generic 3D render. Composition: ONE bold oversized visual metaphor as the hero object on a seamless dark graphite studio backdrop, generous negative space, cinematic depth, subtle film grain. Palette strictly limited: deep graphite blacks, warm ivory, and ONE saturated emerald green accent (#00C896) applied only to the single most meaningful element. The metaphor must be witty, intelligent and slightly surreal, translating the news into an unexpected physical object or scene. Examples of the tone: a marble column cracking under the weight of a feather, a house of cards where exactly one card glows green, a row of dominoes stopped by a small sphere, a thick rope fraying strand by strand with one green strand holding, an umbrella standing alone under a spotlight of falling confetti, a chess king lying down while a pawn stands in the light. CRITICAL RULE, NEVER VIOLATE: do not draw Bitcoin, Ethereum or any cryptocurrency coin, token, symbol or logo anywhere, even when the subject is about them; express the idea exclusively through the physical metaphor. Also strictly forbidden: candlestick charts, price graphs, trading screens, monitors, keyboards, rockets, moons, bulls, bears, laser eyes, businessmen, handshakes, city skylines, vault doors, piggy banks, floating holograms. Absolutely no text, letters, numbers, watermarks or logos in the image. Rich tactile detail, iconic and memorable composition, museum-poster quality. 16:9. Remember the critical rule: zero coins and zero crypto logos in the final image.`;
